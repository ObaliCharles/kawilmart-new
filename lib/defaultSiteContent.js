...
export const defaultSiteContent = {
    ...
    newsletter: {
        ...
        description: "Join the newsletter for newly added products, active flash deals, and seller updates from Wilwa.",
        buttonText: "Subscribe",
    },
    aboutPage: {
        eyebrow: "About Wilwa",
        title: "Northern Uganda's trusted online marketplace for fashion, beauty, electronics, and everyday essentials.",
        intro: "Wilwa was built to make quality products easier to discover, compare, and buy from anywhere. We focus on categories people actually shop online in Uganda, backed by reliable local sellers and a smoother online marketplace experience.",
