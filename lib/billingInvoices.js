...
export const buildSellerInvoiceNotificationPayload = ({
    ...
    if (markedPaid) {
        return {
            ...
            emailTitle: `Wilwa invoice paid: ${serialized.invoiceNumber}`,
    ...
    if (markedOverdue) {
        return {
            ...
            emailTitle: `Wilwa invoice overdue: ${serialized.invoiceNumber}`,
    ...
    return {
        ...
        emailTitle: reminder
            ? `Wilwa invoice reminder: ${serialized.invoiceNumber}`
            : `Wilwa invoice ready: ${serialized.invoiceNumber}`,
